...
JFrame frame = new JFrame ();
	private void createBook() {
		...
		String pic = "sup-bird.png";
		String pic2= "sup-cat.jpg";
	// 6. create a variable of type "JLabel" but don’t initialize it yet
		...
		blabel=loadImageFromComputer(pic2);
	...
	public void mousePressed(MouseEvent e) {
		...
		String pic3= "Eye-Benders-Shutterstock1.jpg";
		clabel = loadImageFromComputer(pic3);
		// 14. pack the frame
		frame.add(clabel);
		frame.pack();
	}
